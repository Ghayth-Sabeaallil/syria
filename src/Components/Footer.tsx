...
function Footer() {
    return (
        <footer className="backdrop-blur-sm bg-transparen flex justify-center items-center p-4 h-fit bottom-0 left-0 z-1000 backdrop-blur bg-transparent border-2 border-black shadow-xl rounded-lg m-4 gap-4">
