...
function Footer() {
    return (
        <footer className="flex justify-center align-center p-4 h-fit fixed bottom-0 left-0 w-full z-1000 bg-transparent backdrop-blur-lg shadow space-x-5 relative">
